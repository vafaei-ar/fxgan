...
class SGAN(object):
    def __init__(self, data_provider, batch_size=64, n_side=4,
                 ...
                 checkpoint_dir=None,save_per = 500, noise_fucntion=None):
...
#        run_config = tf.ConfigProto ()
    ...
    def build_model(self):
        ...
        self.e_loss = tf.reduce_sum(tf.pow(self.E_in - self.ext, 2))
    ...
    def train(self,learning_rate=0.0002,beta1=0.5,num_epoch=25,
        ...
        e_optim = tf.train.AdamOptimizer(learning_rate, beta1=beta1).minimize(self.e_loss,var_list=self.e_vars)
